...
export default function Home() {
    return (
        <div className=" flex-col">
            ...
            <main className="grid grid-cols-1 w-full max-w-6xl gap-16 px-8 lg:px-16 pt-4 pb-0 items-center">
                <div className="flex flex-col items-start">
                    ...
                    <p className="mt-6 text-xl text-muted-foreground leading-relaxed max-w-8/10 font-zalando">
                    ...
                    <div className="flex gap-10 mt-10">
                        ...
                        <div>
                            ...
                            <p className="text-xl text-muted-foreground font-zalando">
                                Personal <br /> Projects
                            </p>
                        </div>

                        <div>
                            <h2 className="text-6xl font-semibold">10+</h2>
                            <p className="text-xl text-muted-foreground font-zalando">
                        ...
                        <div>
                            <h2 className="text-6xl font-semibold">7+</h2>
                            <p className="text-xl text-muted-foreground font-zalando">
                                Proxmox <br /> Services
                            </p>
                        </div>
